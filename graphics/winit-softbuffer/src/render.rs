...
pub fn render(buffer: &mut [u32], scale: f64, width: u32, height: u32, graphics: &Vec<Graphic>) {
...
pub fn render_rectangle(
    ...
    let mut sxw = s * (rectangle.x + rectangle.width) as usize;
    let mut syh = s * (rectangle.y + rectangle.height) as usize;
